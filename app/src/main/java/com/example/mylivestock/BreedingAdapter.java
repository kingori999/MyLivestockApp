...
public class BreedingAdapter extends RecyclerView.Adapter<BreedingAdapter.BreedingViewHolder> {
    ...
    public void onBindViewHolder(@NonNull BreedingViewHolder holder, int position) {
        ...
        holder.femaleLivestockNameTextView.setText("Name: " + breedingRecord.getFemaleLivestockName());
        holder.maleLivestockNameTextView.setText("Male breed name: " +breedingRecord.getMaleLivestockName());
        holder.breedingDateTextView.setText("Breeding Date: " + breedingRecord.getBreedingDate());
        //holder.expectedDueDateTextView.setText(breedingRecord.getExpectedDueDate());
        holder.methodTextView.setText("Breeding Method: " + breedingRecord.getMethod());
    ...
    public int getItemCount() {
        return breedingList != null ? breedingList.size() : 0;
    }
